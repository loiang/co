...
targeted package runs such as `./tools/argument-comment-lint/run-prebuilt-linter.py -p codex-core`.
...
The Bazel aspect path covers `//codex-rs/...`. The Python wrappers remain the
package-scoped escape hatch and default the underlying Cargo invocation
